...
pub struct Context<T, U> {
    pub system: Rc<RefCell<TruthManagementSystem<T, U>>>,
}

impl<T: Clone + Debug, U: Clone + Debug> context::Context for Context<T, U> {}

impl<T, U> fmt::Debug for Context<T, U> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "Truth Management System Context")
    }
}
