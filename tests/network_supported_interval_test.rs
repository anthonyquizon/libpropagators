...
//fn test_network_supported_interval_barometer() {
    ...
    //network.write_cell(
        //building_shadow, 
        //Supported::new(Interval::new(5490, 5510), &[String::from("shadows")])
    //);

    //network.write_cell(
        //barometer_height,
        //Supported::new(Interval::new(30, 32), &[String::from("shadows")])
    //);

    //network.write_cell(
        //barometer_shadow, 
        //Supported::new(Interval::new(36, 37), &[String::from("shadows")])
    //);
